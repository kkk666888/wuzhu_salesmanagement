...
export default {
  ...
  methods: {
    ...
    onExport() {
      ...
      this.$api.customerDetail.exportData.send(params, { showLoading: true }).then(res => {
        console.log('res ===> ' + JSON.stringify(res))
        exportFile(res.data, '客户明细')
      })
    },
    getList(pageInfo, callback) {
      ...
      this.$api.customerDetail.queryData.send(params, { showLoading: true }).then(res => {
