      ...
      <div class="index-right">
        <div id="indexTabs" class="index-tabs">
          <div id="tabContainer" class="tab-container">
            <span
              class="tab-item"
              :class="{'tab-item-active':routeTabs.active === item.name}"
              v-for="item in routeTabs.data"
              :key="item.id"
              @click="tabClick(item)"
            >
              <span
                ...
                class="span-star"
                :class="{'span-star-active':routeTabs.active === item.name}"
              >
              ...
              <span
                v-if="item.name!='index'"
                class="span-close"
                :class="{'span-close-active':routeTabs.active === item.name}"
                @click="tabRemove($event,item)"
              >
